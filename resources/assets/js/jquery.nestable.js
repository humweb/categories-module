    ...
    Plugin.prototype = {
        ...
        dragStop: function (e) {
            ...
            if ($.isFunction(this.options.dropCallback)) {
                ...
                this.options.dropCallback.call(this, {
                    element: el.data('id'),
                    parent: (parent.length && !parent.is('.' + this.options.rootClass)) ? parent.data('id') : null,
                    left: left.length ? left.data('id') : null,
                    right: right.length ? right.data('id') : null
                });
            }
            ...
            if (that.dd) {
                ...
                that.dd.nestable({
                    ...
                    dropCallback: function (data) {
                        var tree = that.dd.nestable('serialize');
                        console.log('Trying to run callback func...');
                        if (tree != that.dd.data('tree')) {
                            console.log('Running callback func...');
                ...
                that.dd.data('tree', that.dd.nestable('serialize'));
                // action button
